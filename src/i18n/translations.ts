...
export const translations = {
  sv: {
    ...
    comingSoonTitle: 'Mer info kommer snart',
    comingSoonMessage:
      'Här publiceras program, OSA och praktisk information när det närmar sig.',
  ...
  en: {
    ...
    comingSoonTitle: 'More info coming soon',
    comingSoonMessage:
      'Schedule, RSVP and practical details will be shared here closer to the date.',
    addToCalendar: 'Add to calendar',
    calendarTitle: 'Wedding — {{partnerOne}} & {{partnerTwo}}',
    calendarDescription: 'Wedding weekend 6–8 August 2027. Ceremony on 7 August.',
